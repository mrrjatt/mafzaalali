      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            subTitle="National College of Business Administraion and Econmics (2028 - 2022)"
            result="3.6 CGPA"
            des="Studied IT related subjects like Operating Systems, DBMS, OOPS, ML, Web Development, AI, DSA, Compiler Design etc."
          />
          <ResumeCard
            title="Higher Secondary Education Intermediate(FSc-engineering)"
            subTitle="Punjab Group of Colleges (2014 - 2016)"
            result="54.15%"
            des="Studied in this school from 11th to 12th std. HSC Subjects: Physics, English, Mathematics, Chemistry. "
          />
          <ResumeCard
            title="Matriculation"
            subTitle="Govt Colony Secondary School (2012 - 2014)"
            result="62% "
            des="Studied in this school from 9th to 10th std. SSC Subjects: English, Chemistry, Biology, Maths, Urdu, Physics."
          />
        </div>
      </div>
      {/* part Two */}
